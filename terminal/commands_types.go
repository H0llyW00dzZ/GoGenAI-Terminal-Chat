...
// Note: this list of commands already implemented,
// now located here for easy maintain and avoiding a fucking complex that I don't fucking understand
// like why everyone (mostly) write go so complex then always having problem
